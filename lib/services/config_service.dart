...
class Configs {
  ...
  factory Configs.fromYMLMap(YamlMap map) {
    return Configs(
      ...
      deleteEmployeeFunctionID: map['deleteEmployeeFunctionID'] as String,
      searchADUserFunctionID: map['searchADUserFunctionID'] as String,
      addNewEmployeeFunctionID: map['addNewEmployeeFunctionID'] as String,
      ...
      editEmployeeFunctionID: map['editEmployeeFunctionID'] as String,
