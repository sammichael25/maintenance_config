class SupabaseSelectConstants {
  ...
  static const String permissionsSelectFields = 'id, name, description, permission_groups:group_id($permissionGroupSelectFields)';
  ...
  static const String employeeSelectFields = 'id, employee_id, first_name, last_name, email, user_dn, job_title, phone_extension, workstation_ip, role:role_id($roleSelectFields)';
