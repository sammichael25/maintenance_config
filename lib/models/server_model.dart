...
class WindowsServerModel extends ServerModel with EquatableMixin {
  ...
  factory WindowsServerModel.fromMap(Map<String, dynamic> map) {
    return WindowsServerModel(
      ...
      memoryUsedCapacity: map['memoryUsedCapacity'],
      memoryMaxAllowedCapacity: map['memoryMaxAllowedCapacity'],
  ...
  factory WindowsServerModel.fromDoc(Document doc) {
    return WindowsServerModel(
      ...
      memoryUsedCapacity: doc.data['memoryUsedCapacity'],
      memoryMaxAllowedCapacity: doc.data['memoryMaxAllowedCapacity'],
  ...
  factory WindowsServerModel.fromPS(Map<String, dynamic> map) {
    return WindowsServerModel(
      ...
      memoryUsedCapacity: map['TotalUsedMemoryCapacityGB'],
      memoryMaxAllowedCapacity: map['MaxMemoryCapacityGB'],
